...
// import api from "../api/api";
// import { FaStar } from "react-icons/fa";
// import ReviewsPopup from "./ReviewsPopup"; // Separate popup component
// import "../styles/PujaList.css";
...
//   const [currentPage, setCurrentPage] = useState(1);
//   const [totalPages, setTotalPages] = useState(1);
//   const [selectedPuja, setSelectedPuja] = useState(null); // For popup
...
//       {/* Reviews Popup */}
//       {showReviews && selectedPuja && (
//         <ReviewsPopup puja={selectedPuja} closePopup={closeReviews} />
//       )}
//     </div>
//   );
// };
...
import api from "../api/api";
import { FaStar } from "react-icons/fa";
import ReviewsPopup from "./ReviewsPopup"; // Popup component
import "../styles/PujaList.css";
